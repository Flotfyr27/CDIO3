...
public class Board {
    ...
    private void setFields(){
        ...
        fields[3] = (new ChanceField("CHANCE", "",Color.lightGray, chanceCardArray));
        ...
        fields[9] = (new ChanceField("CHANCE", "", Color.lightGray, chanceCardArray));
        ...
        fields[15] = (new ChanceField("CHANCE", "", Color.lightGray, chanceCardArray));
